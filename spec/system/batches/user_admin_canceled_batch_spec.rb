...
describe 'Usuário admin cancela lote' do
  it 'com data de fim passada' do
    ...
    batch = Batch.new(code: 'AcSx*1-mL', start_at: DateTime.now.prev_day(50), end_at: DateTime.now.prev_day(10), minimum_bid: 100, minimum_bid_difference: 10, create_by: admin)
    ...
    expect(page).to have_content 'Lote tem lance, então só pode finalizar'
  end

  it 'com data de fim maior que atual com lance' do
    admin = User.create!(name: 'Leo', cpf: '354.410.250-18', email: 'leo@leilaodogalpao.com.br', password: 'password')
    user = User.create!(name: 'Leandro', cpf: '713.289.120-00', email: 'leandro@email.com', password: 'password')
    category = Category.create!(name: 'Eletrônico', description: 'Incididunt officia occaecat consequat aliquip pariatur aute culpa.')
    ...
    batch = Batch.new(code: 'AcSx*1-mL', start_at: DateTime.now, end_at: DateTime.now.next_day(20), minimum_bid: 100, minimum_bid_difference: 10, create_by: admin)
    batch.save(validate: false)
    batch.approved!
    item.batch = batch
    item.unavailable!
  ...
  it 'com data de fim maior que atual sem lance' do
    admin = User.create!(name: 'Leo', cpf: '354.410.250-18', email: 'leo@leilaodogalpao.com.br', password: 'password')
    user = User.create!(name: 'Leandro', cpf: '713.289.120-00', email: 'leandro@email.com', password: 'password')
    category = Category.create!(name: 'Eletrônico', description: 'Incididunt officia occaecat consequat aliquip pariatur aute culpa.')
    ...
    expect(page).to have_content 'Lote foi cancelado com sucesso'
  end

  it 'com data de fim passada sem lance' do
    admin = User.create!(name: 'Leo', cpf: '354.410.250-18', email: 'leo@leilaodogalpao.com.br', password: 'password')
    user = User.create!(name: 'Leandro', cpf: '713.289.120-00', email: 'leandro@email.com', password: 'password')
    category = Category.create!(name: 'Eletrônico', description: 'Incididunt officia occaecat consequat aliquip pariatur aute culpa.')
