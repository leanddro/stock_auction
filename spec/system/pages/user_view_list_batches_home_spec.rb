...
describe 'Usuário vê lista de lotes na tela inicial' do
  ...
  it 'com sucesso' do
    ...
    current_batch = Batch.create!(code: 'AcSx*1-mL', start_at: DateTime.now, end_at: DateTime.now.next_day(20), minimum_bid: 100, minimum_bid_difference: 10, create_by: user)
